...
function Footer() {
  ...
  return (
    <footer className="mt-20 py-12 px-6">
      <Container style="space-y-10">
        <section className="flex gap-10 items-center w-full md:w-11/12 mx-auto ">
          <div className="bg-dark-purple md:basis-9/12 px-5 py-10 rounded-2xl flex gap-4 flex-wrap">
            <h2 className="text-xl md:text-2xl md:basis-1/2">
              Subscribe to our newsletter and receive updates!
            </h2>
            <div className="md:basis-1/2 flex flex-wrap gap-4 items-center">
              <input
                type="email"
                placeholder="Enter e-Mail"
                className="bg-primary basis-full md:basis-9/12 p-3 rounded-md placeholder:text-white outline-none"
              />
              <button className="basis-full md:basis-1/4 bg-purple-monster hover:bg-purple-monster/75 transition duration-200 p-3 rounded-md">
                SEND
              </button>
            </div>
          </div>
